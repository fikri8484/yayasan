                    ...
                    <div class="card-body">
                        ...
                        <div class="progress progress-xs">
                            ...
                            ?>
                               ...
                               ?>
                            @if ($newProgram->donation_target == 9999999999999999 or $different_days1 > 1000)
                            <div class="progress-bar progress-bar-secondary" role="progressbar" aria-valuenow="{{$barr}}" aria-valuemin="0" aria-valuemax="100" style="width:100%">
                            </div>      
                            @else 
                        ...
                        <div class="col-lg-12">
                            <p style="text-align: center;"> <strong class="text-color-primary">
                                    ...
                                    @if ($different_days1 == 0) Kurang dari 1 @elseif ($different_days1 > 1000) <i class="fas fa-infinity"></i> @else {{$different_days1}} Hari Lagi @endif </strong> / Terkumpul <strong class="text-color-primary" style="text-align: right;"> @if ($newProgram->donation_collected == 0)
                                    Rp. 0
                                    @else
